...
//   constructor() {
//     super()
//     this.state = { mobileNavOn: false }

//     this.mobileClick = this.mobileClick.bind(this)
//   }
//   mobileClick() {
//     this.setState(state => ({ mobileNavOn: !state.mobileNavOn }))
//   }
...
//       <>
//         <MobileMenu
//           className={this.mobileNavOn ? ".show-on-medium-and-down" : null}
//         />
//         <header className="container">
//           <div className="nav-container">
//             <div className="logo">
//               <Link to="/">
//                 <Image visual={data.logo.childImageSharp.fluid} />
//               </Link>
//             </div>
//             <div
