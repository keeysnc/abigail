...
const DriversImprovement = ({ intl }) => {
  let pagetitle = `Improving Your Driving`
  let message = `Abigail's Driving School provides a driver improvement course for those in Richmond, Virginia. Our scheduling is very flexible to ensure that all our students can attend and learn proper defensive driving techniques. We are certified by the National Traffic Safety Institute. Our certification is acknolwedged by Virginia DMV and Virginia's Court System. Upon completion of the course, we will report your completion records to the DMV within 24 hours. `
  ...
  return (
    <Layout>
      ...
      />
      <CardRender message={message} pagetitle={pagetitle} />
      <HorizontalRule />
      <CourseInfo
